...
class ShowReservation extends React.Component {
    ...
    componentDidUpdate(){
        ...
        this.map = new mapboxgl.Map({
            ...
            center: [this.props.reservation.listing.longitude, this.props.reservation.listing.latitude],
            zoom: 12,
        });

        new mapboxgl.Marker()
        .setLngLat([this.props.reservation.listing.longitude, this.props.reservation.listing.latitude])
        .addTo(this.map)
    }
    ...
    render(){
        ...
        if (start.getTime() > new Date().getTime()) {
            button = <button onClick={()=>this.props.deleteReservation(this.props.reservation.id)}>Cancel Reservation</button>
        } else {
            button = <div></div>
        }
        ...
        return (
            <div className="respage">
                <div className="rescontainer">
                    <div>
                        <img className="resimg" src={this.props.reservation.photos[0]} width="400" height="400"/>
                    </div>
                    <div id="resmapcontainer" width="400" height="400"></div>
                </div>
               
               <div className="resinfo">
                    <h4 className="restitle">Your trip to {this.props.reservation.listing.title} </h4>
                    <br />
                    <p>check in: {start}</p>
                    <p>check out: {end}</p>
                    ...
                    <address>
                        Location: <br />
                        {this.props.reservation.listing.street_address}, {this.props.reservation.listing.city}, {this.props.reservation.listing.country}, {this.props.reservation.listing.postcode} <br />
                    </address>
