...
const ListingItem = (props) => {
  ...
  if (props.listing.house_elf) {
    ...
    houseElf = (
      <p className="listingp">This listing doesnt come with house elves</p>
    );
  }
  if (props.listing.owl_friendly) {
    ...
    owlFriendly = (
      <p className="listingp">Keep your owls home they are not welcome here</p>
    );
  }
      ...
      <div className="listingdiv">
        ...
        <li className="indlisting">
          ...
          <p className="listingp">
            {" "}
            {props.listing.num_of_beds * 2} guests • {props.listing.num_of_beds}{" "}
            beds{" "}
          </p>
          <br />
          <address>
